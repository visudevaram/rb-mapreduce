...
public class RbMapReduceSavings {
    // Mapper class
    ...
    Text> /* Output value Type */
    {
        ...
        private void dataFilteration(OutputCollector<Text, Text> output, String line) throws IOException {
            final ArrayList<String> messageContentKeysList = RbMapReduceSavings.getSavingsMessageContentKeysList();
    ...
    public static void main(String args[]) throws Exception {
        JobConf conf = new JobConf(RbMapReduceSavings.class);
        conf.setJobName("rb_map_reduce_savings");

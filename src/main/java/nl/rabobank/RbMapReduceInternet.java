...
public class RbMapReduceInternet {
    // Mapper class
    ...
    Text> /* Output value Type */
    {
        ...
        private void dataFilteration(OutputCollector<Text, Text> output, String line) throws IOException {
            final ArrayList<String> messageContentKeysList = RbMapReduceInternet.getInterBankingMessageContentKeysList();
    ...
    public static void main(String args[]) throws Exception {
        JobConf conf = new JobConf(RbMapReduceInternet.class);
        conf.setJobName("rb_map_reduce_internet");

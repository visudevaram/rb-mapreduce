...
public class RbMapReduceCards {
    ...
    Text> /* Output value Type */
    {
        ...
        private void dataFilteration(OutputCollector<Text, Text> output, String line) throws IOException {
            final ArrayList<String> messageContentKeysList = RbMapReduceCards.getCardMessageContentKeysList();
    ...
    public static void main(String args[]) throws Exception {
        JobConf conf = new JobConf(RbMapReduceCards.class);
        conf.setJobName("rb_map_reduce_cards");
